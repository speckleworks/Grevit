...
namespace Grevit.Revit
{
  ...
  class GrevitUI : IExternalApplication
  {
    ...
    public Result OnStartup( UIControlledApplication application )
    {
      ...
      // Speckle button
      PushButton speckleButton = grevitPanel.AddItem( new PushButtonData( "Speckle Client", "Speckle Client", path, "Grevit.Revit.SpeckleCommand" ) ) as PushButton;
      ...
      speckleButton.LargeImage = System.Windows.Interop.Imaging.CreateBitmapSourceFromHBitmap(
          ...
          IntPtr.Zero,
          System.Windows.Int32Rect.Empty,
          BitmapSizeOptions.FromWidthAndHeight( 40, 32 ) );
