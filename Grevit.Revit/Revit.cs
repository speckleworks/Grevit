...
namespace Grevit.Revit
{
  ...
  class GrevitUI : IExternalApplication
  {
    ...
    public Result OnStartup( UIControlledApplication application )
    {
      ...
      PushButton speckleButton = grevitPanel.AddItem( new PushButtonData( "Speckle Client", "Speckle Client", path, "Grevit.Revit.GetSpeckleStream" ) ) as PushButton;
  ...
  [Transaction( TransactionMode.Manual )]
  public class GetSpeckleStream : IExternalCommand
  {
    public Result Execute( ExternalCommandData commandData, ref string message, ElementSet elements )
    {
