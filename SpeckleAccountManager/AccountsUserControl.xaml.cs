    ...
    public partial class AccountsUserControl : UserControl
    {
        ...
        private void RegisterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                saveAccountToDisk(RegisterEmail.Text, response.Resource.Apitoken, (string)serverName, RegisterServerUrl.Text, RegisterServerUrl.Text, isDefault);
        ...
        private void LoginButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                var serverName = parsedReply.serverName;
                var isDefault = accounts.Any() ? false : true;
                saveAccountToDisk(myUser.Email, response.Resource.Apitoken, (string)serverName, ServerAddress.ToString(), ServerAddress.ToString(), isDefault);
